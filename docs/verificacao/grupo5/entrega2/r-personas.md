# Resultados da Verificação por Inspeção - Personas

## Introdução

Este documento apresenta o objetivo da verificação, a metodologia utilizada e os dados obtidos após a realização da análise do artefato [Personas](../../../elicitacao/grupo5/personas.md).

## Objetivo

Este documento tem como objetivo apresentar os resultados obtidos nas verificações realizadas sobre o artefato [Personas](../../../elicitacao/grupo5/personas.md).
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/3gw7qIcnbcg?si=YrmP6Ioclv-BHukN&amp;start=1252" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- ID 4 - Figuras sem chamada no texto.

## Bibliografia

> Tesouro Direto. Personas, disponível em: https://requisitos-de-software.github.io/2024.2-TesouroDireto/elicitacao/grupo5/personas/. Acesso em: 27 de janeiro de 2025.
